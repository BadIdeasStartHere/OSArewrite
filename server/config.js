module.exports = {
    ...
    host: "arrasserver.onrender.com", // Game server domain. If the host is 'localhost:NUMBER', the NUMBER must be the port setting.
    ...
    servers: [ // Make sure to change the HOST, PORT and SERVER_ID between servers!
        {
            ...
            host: "arrasserver.onrender.com:3001",
